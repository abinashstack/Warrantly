...
router.get('/:invoiceId', requireAuth, async (req, res) => {
    console.log("Fetch invoice endpoint hit for invoice ID: ", req.params.invoiceId);
    try {
...
//     console.log("Invoices post endpoint triggered.");
...
//     console.log("Product ID: ", user_product_id, invoice_date);

//     if (!user_product_id || !invoice_date) {
//         return res.status(400).json({
//             error: 'user_product_id and invoice_date are required',
//         });
//     }
